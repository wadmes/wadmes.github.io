...
\begin{rSection}{Research Experience - In University}
    ...
    {\bf {Multi-modal agentic AI for EDA }}
    \begin{itemize}[noitemsep,topsep=-5pt]
        ...
        \item Outlines two challenging case studies—automated \underline{RTL coding} and \underline{Timing ECO}—to demonstrate the framework's effectiveness.
    ...
    \end{itemize}
    {\bf {Graph Modality in LLMs for VLSI \textbf{[{{ICLAD'25, Best Paper Honorable Mention}}]}}}
    \begin{itemize}[noitemsep,topsep=-5pt]
        \item Pioneered the integration of \underline{graph modality into LLMs} specifically for VLSI design.
        \item Engineered a fully automated, high-throughput data collection pipeline, curating a massive-scale dataset with over \underline{\textbf{10 billion training tokens}}.
        \item Garnered exceptional interest from industry, invited to deliver an internal technical talk at \textbf{Apple} to an audience of \underline{\textbf{100+ engineers}}.
    \end{itemize}
    {\bf {Global Floorplanning using Semidefinite Programming \textbf{[{{DAC'23}}]}}} 
    \begin{itemize}[noitemsep,topsep=-5pt]
        \item A SDP-based method for finding the {best locations of modules} in a chip; reduced wirelength by 3.02\%--20.01\%
...
\begin{itemize}[noitemsep,topsep=-5pt]
    \item Developed \href{https://github.com/limbo018/OpenMPL}{\textbf{OpenMPL}}, a comprehensive open-source framework featuring high-performance implementations of state-of-the-art layout decomposition algorithms.
    \item Achieved \textbf{80+ GitHub stars}; the tool has been widely adopted as a \underline{baseline for benchmarking} layout decomposition research.
    \item Identified critical algorithmic shortcomings in legacy heuristics and proposed optimized solutions that significantly improved decomposition success rates and scalability.
\end{itemize}
...
\begin{rSection}{Research Experience - In Industry}
    ...
    \begin{itemize}[noitemsep,topsep=-5pt]
        ...
        \item Resulted in a \underline{patent filing with NVIDIA Research}; officially released as an 
        \href{https://github.com/NVlabs/Differentiable-Global-Router}{open-source framework} 
        via {NVIDIA Labs}.    
    \end{itemize} 
