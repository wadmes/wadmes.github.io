...
\begin{rSection}{Research Experience - In University}
    ...
    {\bf PhD candidate, Carnegie Mellon University, United States}               \hfill { Sep.~2021 -- Now} \\
    {\bf \textit{Multi-modal agentic LLMs for EDA }}
    \begin{itemize}[noitemsep,topsep=-5pt]
        ...
        \item Investigate the \underline{new problem-solving strategies} that emerge from this increased agent autonomy. 
    ...
    \end{itemize} 
    % \list{1}{2}
    {\bf \textit{DEFT: Differentiable Automatic Test Pattern Generation}}
    \begin{itemize}[noitemsep,topsep=-5pt]
    ...
    \end{itemize}
    {\bf \textit{Graph modality in LLMs \textbf{[{{ICLAD'25, Best Paper Honorable Mention Award}}]}}}
    \begin{itemize}[noitemsep,topsep=-5pt]
    ...
    \end{itemize} 
    {\bf \textit{Global Floorplanning using Semidefinite Programming \textbf{[{{DAC'23}}]}}} 
    \begin{itemize}[noitemsep,topsep=-5pt]
    ...
    \end{itemize} 
    {\bf \textit{Pseudo-Exhaustive Physically-Aware Region Testing \textbf{[{ITC'22}]}}}
    \begin{itemize}[noitemsep,topsep=-5pt]
    ...
    \end{itemize}
    {\bf \textit{GNN study in logic locking \textbf{[{MLCAD'23}]}}} 
    \begin{itemize}[noitemsep,topsep=-5pt]
...
% \list{1}{2}
{\bf \textit{Routing Tree Construction \textbf{[{ASP-DAC'21, Best Paper Award}]}}}
\begin{itemize}[noitemsep,topsep=-5pt]
...
\end{itemize}
{\bf \textit{Adaptive Layout Decomposition \textbf{[{DAC'20, TCAD'21}]}}}
\begin{itemize}[noitemsep,topsep=-5pt]
...
% {\bf \textit{Reviewed paper for AAAI'22, about GNNs for graph coloring}\\ \\
{\bf Research Assistant, The Chinese University of Hong Kong, Hong Kong}               \hfill { Feb.~2019 -- July.~2019} \\
{\bf \textit{Open-source Layout Decomposition Framework \textbf{[{TCAD'21}]}}}
\begin{itemize}[noitemsep,topsep=-5pt]
...
\end{itemize}
{\bf \textit{Acceleration and Compression of DNNs \textbf{[{ICTAI'19, Best Student Paper Award}]}}}
\begin{itemize}[noitemsep,topsep=-5pt]
...
{\bf \textit{Testing of Auto-driving Systems \textbf{[{ICSE'20}]}}}
\begin{itemize}[noitemsep,topsep=-5pt]
...
\end{itemize}
{\bf \textit{Fault Localization \textbf{[{ISSTA'19, Distinguished Paper Award}]}}}
\begin{itemize}[noitemsep,topsep=-5pt]
...
\begin{rSection}{Research Experience - In Industry}
    ...
    % \list{1}{2}
    {\bf \textit{Differentiable Global Routing \textbf{[{{DAC'24}}]}}}
    \begin{itemize}[noitemsep,topsep=-5pt]
...
% \list{1}{2}
{\bf \textit{Exploration of GNNs for Physical Design }}
\begin{itemize}[noitemsep,topsep=-5pt]
...
\end{itemize}
{\bf \textit{Perfect Rectilinear Floorplanning}}
\begin{itemize}[noitemsep,topsep=-5pt]
