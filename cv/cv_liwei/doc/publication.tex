\begin{rSection}{Publications}
    ...
    %{{{
        \item[{[J2]}]{
            ...
            ``Adaptive Layout Decomposition with Graph Embedding Neural Networks'', submitted to IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (\textbf{TCAD}).
        }
        \item[{[J1]}]{
...
%{{{
    \item[{[C11]}]{
        \textbf{Wei Li}, Chris Nigh,  Fangzhou Wang, Jose Moura, Shawn Blanton, 
