...
%{{{
    \item[{[18]}]{
        \textbf{Wei Li}, Yang Zou, Yixin Liang, Shawn Blanton and José Moura,
        ``DEFT: Differentiable Framework for Circuit Testing'', ACM/IEEE Design Automation Conference ({DAC}), 2026, Under Review. 
    }
    \item[{[C17]}]{
        \textbf{Wei Li}, Yang Zou, Christopher Ellis, Ruben Purdy, Shawn Blanton and José Moura,
        ``BRIDGE: Bridging Graph and Large Language Models in EDA'', IEEE International Conference on LLM-Aided Design (\textbf{ICLAD}), 2025. \textcolor{red}{\textbf{(Best Paper Award, Honorable Mention)}}
    }
    \item[{[C16]}]{
