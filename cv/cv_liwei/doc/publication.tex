...
%{{{
    \item[{[18]}]{
        ...
        ``DEFT: Differentiable Framework for Circuit Testing'', submitted to ACM/IEEE Design Automation Conference ({DAC}), 2026. 
    }
    \item[{[C17]}]{
        \textbf{Wei Li}, Yang Zou, Christopher Ellis, Ruben Purdy, Shawn Blanton and José Moura,
        ``BRIDGE: Bridging Graph and Large Language Models in EDA'', IEEE International Conference on LLM-Aided Design (\textbf{ICLAD}), 2025. \textcolor{red}{\textbf{(Best Paper Honorable Mention Award, 1/94)}}
    }
    \item[{[C16]}]{
